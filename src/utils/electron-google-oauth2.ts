...
import LoopbackRedirectServer from './loopback-redirect-server'

import * as url from 'url'

const BW: typeof BrowserWindow =
  process.type === 'renderer' ? require('@electron/remote').BrowserWindow : BrowserWindow
...
class ElectronGoogleOAuth2 extends EventEmitter {
  ...
  protected server: LoopbackRedirectServer | null | undefined
  ...
  openAuthWindowAndGetTokens(forceAddSession: boolean = false) {
    return this.getAuthorizationCode(forceAddSession).then((authorizationCode) => {
